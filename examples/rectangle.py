...
_, text_height = surface.write(
    (
        "The rectangle function draws a rectangle of any size, originating at the top-left corner.\n\n"
        "Optional arguments include the colour, whether or not to fill it "
        "with colour, the outline thickness, and the outline colour.\n\n"
        "The width and height of the rectangle take into account the thickness of the "
...
surface.rectangle(
    "center", "center", 250, 250, fill_color=(50, 205, 50, 128), line_color=(255, 0, 0)
)

# Draw an empty rectangle measuring 200x250 pixels with an outline 20 pixels thick
