...
surface.draw.dot(50, 50)

# Draw a blue dot at ("left", 150) with a radius of 20 pixels
surface.draw.dot("left", 150, radius=20, color=(0, 0, 255))

# Draw a lime-green dot at ("center", "center") with a radius of 50 pixels
# and a red outline
surface.draw.dot("center", "center", 50, color=(50, 205, 50), outline_color=(255, 0, 0))

# Draw an empty dot at (200, "top") with a radius of 10 pixels
surface.draw.dot(200, "top", 10, fill=False)
