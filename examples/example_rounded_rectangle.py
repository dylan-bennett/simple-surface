...
# Create the ImageSurfacePlus object and set the background to yellow
...
es.draw.rounded_rectangle("left", 650, width=200, height=100, radius=20, color=(0, 0, 255))
...
es.draw.rounded_rectangle(
    x="right",
    y="bottom",
    width=es.get_width() / 2,
    height=es.get_height() / 2,
